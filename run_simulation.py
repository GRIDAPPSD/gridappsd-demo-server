...
from gridappsd.simulation import Simulation, SimulationConfig, PowerSystemConfig, SimulationArgs
...
sim_args = SimulationArgs(duration=84600)

sim_conf = SimulationConfig(power_system_config = psc, simulation_config=sim_args)
